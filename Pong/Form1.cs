...
namespace Pong
{
    public partial class Form1 : Form
    {
        ...
        private void GameStart()
        {
            ...
            //graphics object, a brush, and a font to display the countdown
            ...
            for (int x = 3; x<=3 && x>0 ;x-- ) // TODO create conditions for a for loop that counts down from 3 
            {
                // --- create code using DrawString to display the countdown in the appropriate area.  
                formGraphics.DrawString(Convert.ToString(x), drawFont, drawBrush, 285, 150);
